...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="Apellido" class="form-control" value="<?php echo $usuario->Apellido;?>" id="Apellido" placeholder="Ej. Av Collar 1005 Col Las Cruces">
        </div>
...
if(isset($_POST['registrar'])){
    ...
    include_once "funciones.php";
    $resultado = editarUsuario($usuario, $nombre, $telefono, $Apellido, $id);
    if($resultado){
        echo'
